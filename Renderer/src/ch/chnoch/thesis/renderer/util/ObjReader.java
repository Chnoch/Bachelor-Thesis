...
/**
 * Reads on .obj file including normals, color coordinates and texture
 * coordinates.
 */
public class ObjReader {

	/**
	 * Reads an .obj file and returns a {@link VertexBuffers} object.
	 * 
	 * @param file
	 *            the file to read.
	 * @param scale
	...
	public static VertexBuffers read(InputStream file, float scale) throws IOException
	{
		...
		// Set the corresponding arrays to the vertexBuffer object
