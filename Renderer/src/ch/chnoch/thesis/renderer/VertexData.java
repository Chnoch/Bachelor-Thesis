...
/**
 * This class is only used for the import of data from an .obj files. For
 * everything else use a {@link VertexBuffers}
 * 
 * Deprecated: Provides functionality to specify 3D geometry in the form of
 * triangle meshes. {@link VertexData} consists of a list of
